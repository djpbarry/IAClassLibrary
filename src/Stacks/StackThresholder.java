...
public class StackThresholder {
    ...
    public static void thresholdStack(ImagePlus imp, int threshold) {
        ...
        for (int i = 1; i <= nSlices; i++) {
            ...
            if(slice instanceof FloatProcessor){
                slice = slice.convertToShort(false);
            }
            slice.threshold(threshold);
            outputStack.addSlice(slice.convertToByteProcessor());
        }
