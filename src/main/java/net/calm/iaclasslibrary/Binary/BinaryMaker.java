 ...
 */
package net.calm.iaclasslibrary.Binary;
...
public class BinaryMaker {
     ...
     * @param method net.calm.iaclasslibrary.Thresholding method
     ...
     * @param method net.calm.iaclasslibrary.Thresholding method to employ
     * @param manualThresh A manual threshold value
     * @param holeSize Approximate size of holes to be filled in mask object
     * @return A binary, thresholded image
     */
    ...
    /*
        Copied from ij.plugin.filter.net.calm.iaclasslibrary.Binary
     */
     ...
     *
     * @param stats net.calm.iaclasslibrary.Image statistics for the image of interest
