 ...
 */
package net.calm.iaclasslibrary.MacroWriter;
...
public class MacroWriter {
    ...
    public static void write() {
        ...
        String content = "filename = \"./plugins/Scripts/CellMotilityWarningIssued.txt\";\n"
                ...
                + "	+\"<p>In order to ensure that you always have the latest version of plugins such as <a href=\\\"https://bitbucket.org/djpbarry/adapt/\\\">ADAPT</a> and <a href=\\\"https://bitbucket.org/djpbarry/particletracker/\\\">net.calm.iaclasslibrary.Particle Tracker</a>, please</p>\"\n"
                ...
                + "	+\"<p>Thanks!</p>\"\n"
                + "	+\"<p>Dave.</p><br>\"\n"
                + "	+\"<p><i>Dave Barry,<br>net.calm.iaclasslibrary.Image Analyst,<br>Crick Advanced Light Microscopy Facility (CALM),<br>The Francis Crick Institute,<br>London NW1 1AT,<br>The non-Brexity part of the UK.</i></p><p><i>david.barry@crick.ac.uk</i></p>\");\n"
                + "	File.saveString(\"net.calm.iaclasslibrary.Cell Motility Warning Issued\",filename);\n"
                + "}";
