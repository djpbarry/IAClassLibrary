...
//                tmin = i + 1 - startIndex;
//                magTmin = net.calm.iaclasslibrary.Math.abs(correlation[i + 1]);
//                return;
//            }
//        }
//        return;
...
//            if (correlation[i] < correlation[i + 1] && correlation[i + 1] > correlation[i + 2] && correlation[i + 1] > 0.0) {
//                tmax = i + 1 - startIndex;
//                magTmax = net.calm.iaclasslibrary.Math.abs(correlation[i + 1]);
//                return;
//            }
//        }
//        return;
...
//        int r, g;
//        if (val >= 0.0) {
//            r = 255 - (int) net.calm.iaclasslibrary.Math.round(255 * val);
//            if (r < 0) {
//                r = 0;
//            }
//            colour = new Color(r, 255, 0);
//        } else if (val < 0.0) {
//            g = 255 + (int) net.calm.iaclasslibrary.Math.round(255 * val);
//            if (g < 0) {
//                g = 0;
//            }
...
//        return colour;
//    }
    public ImageProcessor calcRateOfChange(ImageProcessor input) {
