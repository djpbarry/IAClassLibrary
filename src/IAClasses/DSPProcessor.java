...
//        plot1.show();
     ...
     * "Fractal Images and Image Processing," in <i>Digital Image
...
//        plot3.show();
     ...
     */
    public static double[] upScale(double[] input, int n) {
        int i, j, k, inputLength = input.length;

        int outputLength = (int) Math.pow(2, n);
